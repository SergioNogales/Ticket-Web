<html lang="es">
    ...
    <body>
        ...
        <main>
            <section class="main">
                <div id="titulo"><h1>Lista de eventos</h1></div>
                <div class="barra2"></div>
            </section>
            <section id="eventos">
                <article class="evento" id="a1">
                    <div class="fila">
                        <div>
                            <div class="tituloEvento">Circo del Sol - BAZZAR</div>
                            <div class="descEvento">Las Meloneras(Maspalomas)</div>
                            <div class="fecha">Lunes 20 de Enero 2025</div>
                        </div>
                        <a class="eventoBoton ignoreLink" href="detallesEvento.php">Detalles</a>         
                    </div>
                </article>
                <div class="barra3"></div>
                <article class="evento" id="a2">
                    <div class="fila">
                        <div>
                ...
                <article class="evento" id="a3">
                    <div class="fila">
                        <div>
                            <div class="tituloEvento">Katherine Ryan - Battleaxe</div>
                            <div class="descEvento">Madrid, Sala Specka</div>
                            <div class="fecha">Viernes 7 de Febrero 2025</div>
                        </div>
                        <a class="eventoBoton ignoreLink" href="detallesEvento.php">Detalles</a>                    
                    </div>
                </article>
                <div class="barra3"></div>
                <article class="evento" id="a4">
                    <div class="fila">
                        <div>
                            <div class="tituloEvento">Dancing Plague</div>
