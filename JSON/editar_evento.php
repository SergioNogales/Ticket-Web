<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="editar_evento.css">
    ...
    <body>
        ...
        <main>
            <section class="main">
                <div id="titulo"><h1>Edición de evento</h1>
                Los atributos marcados con * son obligatorios de rellenar</div>
                    ...
                    <div id="logindiv">
                        <form class="margin" id="update" method="post" action="#">
                            ...
                            <div class="filaLogin">
                                ...
                                <div class="field"><input type="text" id="descripcion" name="descripcion"></input></div>
                            </div>
                            <div class="filaLogin">
                            ...
                            <div class="filaLogin">
                                <div class="label">Nuevo número de entradas*</div>
                                <div class="field"><input type="text" id="numEntrada" name="numEntrada"></input></div>
                            </div>
                            <div class="filaLogin">
                                <div class="label">Nuevos detalles del evento </div>
                                <div class="field"><input type="text" id="detalles" name="detalles"></input></div>
                            </div>
                            <div class="filaLogin">
                                <button id="updateSend" class="boton">Editar evento</button>
                            </div>
                            <script>
                                $(document).ready(function() {
                                   $('#update').submit(function(event) {
                                       ...
                                       {
                                           error = true;
                                           $('<li>').html("El campo del nombre del evento está vacio").appendTo(listaErrores);
                                       }

                                       if( $('#ubicacion').val() == "") 
                                       {
                                           error = true;
                                           $('<li>').html("El campo de la ubicación del evento está vacio").appendTo(listaErrores);
                                       }

                                       if( $('#descripcion').val() == "") 
                                       {
                                           error = true;
                                           $('<li>').html("El campo de la descripcion del evento está vacio").appendTo(listaErrores);
                                       }

                                       if( $('#precio').val() == "") 
                                       {
                                           error = true;
                                           $('<li>').html("El campo del precio de cada entrada está vacio").appendTo(listaErrores);
                                       }

                                       if( $('#numEntrada').val() == "") 
                                       {
                                           error = true;
                                           $('<li>').html("El campo del número de entradas está vacio").appendTo(listaErrores);
                                       }
                                       else
                                       {
                                            if($('#numEntrada').val() == 0 || $('#numEntrada').val() < 0) 
                                            {
                                                error = true;
                                                $('<li>').html("El número de entradas no puede ser 0 o negativo").appendTo(listaErrores);
                                            }
                                       }
